      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gray-50 border border-gray-100 p-8 rounded-2xl mb-10 flex flex-col items-start transition-all duration-300">
          <h3 className="text-2xl font-bold mb-3 text-gray-900">
            Expand your career with {activeTab}
          </h3>
          <p className="text-gray-600 mb-6 max-w-3xl leading-relaxed">
            Take one of AiLearn's top-rated {activeTab} courses. Whether you're
            a beginner or an expert aiming for certification, we have the right
            curriculum for you.
          </p>
            ...
            {filteredCourses.map((course) => (
              ...
              >
                ...
                <div className="flex flex-col grow">
                  <h3 className="font-bold text-gray-900 leading-tight mb-1 group-hover:text-indigo-600 transition-colors line-clamp-2">
                    {course.title}
                  </h3>
                  ...
                  <div className="flex items-center gap-1 mb-2">
                    ...
                    <div className="flex text-yellow-400">
                      {[...Array(5)].map((_, starI) => (
                        <Star
                          key={starI}
                          className={`w-3 h-3 ${starI < Math.floor(course.rating) ? "fill-current" : "text-gray-300 fill-current"}`}
                        />
                      ))}
                    </div>
        ...
        <div className="mt-12 text-center">
          <button
            ...
            className="px-8 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg font-bold hover:bg-gray-50 hover:border-gray-400 transition-all shadow-sm hover:shadow-md active:scale-95"
          >
            View More Courses
          </button>
        </div>
